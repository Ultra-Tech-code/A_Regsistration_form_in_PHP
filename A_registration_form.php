<?php
 if (isset($_POST['username']) && isset($_POST['intern_id']) && isset($_POST['email']) && isset($_POST['category'])){
     $username = $_POST['username'];
     $intern_id = $_POST['intern_id'];
     $email = $_POST['email'];
     $Category = $_POST['category'];

     echo '<h2 style="color: white;">Form submitted sucessfully <br></h2> ';
    echo "<span>Username: $username <br><br>Intern ID: $intern_id <br><br>Email: $email
    <br><br>Category: $Category</span>";
